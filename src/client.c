...
// Nombre total de valeurs à générer
// TODO : changer le '1' par '250' pour le test final
#define NOMBRE_DE_VALEURS (1 * MILLIARD) 
...
void envoyer_donnees(int *tab)
{
    ...
    // TODO : changer "127.0.0.1" par l'IP du pc serveur
